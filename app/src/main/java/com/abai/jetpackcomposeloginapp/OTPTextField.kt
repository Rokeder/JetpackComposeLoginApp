...
/**
 * Created by Abai Rustemov on 23.01.2023.
 */

@Composable
fun OTPTextField(codeLength: Int, initialCode: String, onTextChanged: (String) -> Unit) {
...
1
    Box(modifier = Modifier.fillMaxWidth(), contentAlignment = Alignment.Center) {
        BasicTextField(
            value = code.value,
            onValueChange = { if (it.text.length <= codeLength) onTextChanged(it.text) },
